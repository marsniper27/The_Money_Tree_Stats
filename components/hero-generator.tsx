    ...
    if(value > usedWallets){
      ...
      if(newTreeCount > 0){
        ...
        for(var x = 0; x < newTreeCount; x++){
          setTrees(prevTrees => {
            return [ ...prevTrees, {...prevTrees[trees.length-1],top:inputValues[trees.length],left:inputValues[usedWallets+offset],center:inputValues[usedWallets+offset+1],right:newInputValues[usedWallets+offset+2]}];
          });
          offset+=3;
        }
