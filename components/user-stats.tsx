    ...
    <section>
      <div className="max-w-6xl mx-auto px-4 sm:px-6 relative">
        ...
        <div className="relative pt-32 pb-10 md:pt-40 md:pb-4">
          ...
          {isError ? (
            <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
              <p>Failed to fetch user data. Please refresh in a minute to try again</p> 
            </div>
          ):null}
        {!isConnecting && !isDisconnected && !isLoading && !isError &&(
                <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
                  <CopyToClipboardDiv text={"https://themoneytree.io/"+address} />
                  <h1 className="h1 mb-4" data-aos="fade-up">User Stats</h1>
                  <h1 className="h1 mb-4" data-aos="fade-up">Investment Tier: {tier ? tier.name : 'Loading...'}</h1>
                  {/* Items */}
